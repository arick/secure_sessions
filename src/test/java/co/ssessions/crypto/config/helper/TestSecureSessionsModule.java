...
public class TestSecureSessionsModule extends SecureSessionsModule {

	public TestSecureSessionsModule() {
	...
	public void doBindCryptoServiceConfiguration() {
		bind(new TypeLiteral<CryptoServiceConfiguration<String,String>>(){}).to(TestMapBasedCryptoServiceConfiguration.class);
	}
